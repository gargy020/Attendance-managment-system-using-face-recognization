...
def CheckAttendance():
    ID = simpledialog.askstring(title="Attendance",
                                 prompt="What's your id?:")
    Date = simpledialog.askstring(title="Attendance",
                                  prompt="Date?:")
    ...
    for i in range(0,len(data.index)):
        ...
        if(x==ID):
            count=count+1
    if(count>0):
        mess._show(title='your attendance is', message="Yes you are present")  
    else:
        mess._show(title='your attendance is', message="sorry you are absent") 
...
takeImg = tk.Button(frame1, text="check attendance", command=CheckAttendance  ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=35, y=500)
